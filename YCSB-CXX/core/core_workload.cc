...
void CoreWorkload::Init(const utils::Properties &p)
{
	...
	double readmodifywrite_proportion =
		std::stod(p.GetProperty(READMODIFYWRITE_PROPORTION_PROPERTY, READMODIFYWRITE_PROPORTION_DEFAULT));
	...
	if (request_dist == "uniform") {
		...
		key_chooser_ =
			new ScrambledZipfianGenerator(insert_start, insert_start + record_count_ + expectednewkeys);
